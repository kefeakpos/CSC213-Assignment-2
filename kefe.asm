...
lwc1 $f3,zero       		        #$f3  holds 0.0 

la $a0,A                                #this is asking user for value of A
li $v0,4
syscall
li $v0,6
syscall
...
la $a0,B                                #this is asking user to enter value of B
li $v0,4
syscall
li $v0,6
syscall
...
la $a0,C                               #this is asking user to enter value of C
li $v0,4
syscall
li $v0,6
syscall
